    ...
    lessons: [
      {
        id: "lesson1.1",
        name: "Lesson 1.1",
        topics: "Introduction to Whole Numbe",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson1.4",
        name: "Lesson 1.4",
        topics: "Multiply and Divide Integer",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.1",
        name: "Lesson 2.1",
        topics: "Solve Equations Using the S",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.2",
        name: "Lesson 2.2",
        topics: "Solve Equations using the D",
        allowRecyle: false,
        learningObjectives: {
          solve_equations_that_require_simplification: 0.95,
      ...
      },
      {
        id: "lesson2.3",
        name: "Lesson 2.3",
        topics: "Solve Equations with Variab",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.4",
        name: "Lesson 2.4",
        topics: "Use a General Strategy to S",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.5",
        name: "Lesson 2.5",
        topics: "Solve Equations with Fracti",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.6",
        name: "Lesson 2.6",
        topics: "Solve a Formula for a Speci",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson3.1",
        name: "Lesson 3.1",
        topics: "Use a Problem-Solving Strat",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson3.4",
        name: "Lesson 3.4",
        topics: "Solve Geometry Applications",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson3.5",
        name: "Lesson 3.5",
        topics: "Solve Uniform Motion Applic",
        allowRecyle: false,
      ...
      },
      {
        id: "lesson3.6",
        name: "Lesson 3.6",
        topics: "Solve Applications with Lin",
        allowRecyle: false,
        learningObjectives: {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        id: "lesson1.2",
        name: "Lesson 1.2",
        topics: "Exponents and Scientific No",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson1.3",
        name: "Lesson 1.3",
        topics: "Radicals and Rational Expon",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.1",
        name: "Lesson 2.1",
        topics: "The Rectangular Coordinate",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.2",
        name: "Lesson 2.2",
        topics: "Linear Equations in One Var",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson2.7",
        name: "Lesson 2.7",
        topics: "Linear Inequalities and Abs",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson3.1",
        name: "Lesson 3.1",
        topics: "Functions and Function Nota",
        allowRecyle: false,
        learningObjectives: {
      ...
      },
      {
        id: "lesson3.3",
        name: "Lesson 3.3",
        topics: "Rates of Change and Behavio",
        allowRecyle: false,
        learningObjectives: {
          decreasing: 0.95,
